 ...
 * `bare` drops this component's own box + label — use when it's already
 * nested inside another titled container (e.g. a CollapsibleSection) so
 * the two don't stack into a redundant box-in-box with a duplicate title.
 */
export default function AssumedVsComputed({ assumptions, bare = false }) {
